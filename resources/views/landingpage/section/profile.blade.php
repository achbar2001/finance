...
<section class="page-section bg-light" data-aos="fade-up" id="contact">
            ...
            <div class="box">
                <form method="POST" action="/profile">
                    ...
                    <div class="row mb-3 ps-5 pe-5" style="text-align: left">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ $profile[0]->name }}">
                            @error('name')
                        ...
                        <div class="col-sm-10 mt-3">
                            <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ $profile[0]->email }}">
                            @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-sm-10 mt-3">
                            <input type="text" class="form-control @error('nomor_telepon') is-invalid @enderror" id="nomor_telepon" name="nomor_telepon" value="{{ $profile[0]->nomor_telepon }}">
                            @error('nomor_telepon')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-sm-10 mt-3">
                            <textarea name="alamat" id="alamat" cols="25" rows="3" class="form-control @error('alamat') is-invalid @enderror">{{ $profile[0]->alamat }}</textarea>
                            @error('alamat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
