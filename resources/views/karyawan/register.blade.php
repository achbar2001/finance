                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style="border-radius: 15px; margin-top:50px">
                        <div class="card-body p-5 mt-3">
                            <h2 class="text-uppercase text-center mb-5">Create an account Karyawan</h2>
                            <form class="row g-3 needs-validation" action='/register/Employee' method="post">
                                ...
                                <div class="form-outline mb-4">
                                    <input type="password" name="id_company" id="id_company" class="form-control form-control-lg  @error('name') is-invalid @enderror" required />
                                    <label class="form-label" for="yourUsername">Company Code</label>
                                    @error('id_company')
                                ...
                                <div class="form-check d-flex justify-content-center mb-5">
                                    <input class="form-check-input mr-2" type="checkbox" value="" id="form2Example3cg" />
