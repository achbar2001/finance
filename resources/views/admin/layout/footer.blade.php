...
<footer id="footer" class="footer">
    ...
    <div class="credits">
        ...
        <a href="https://www.facebook.com/ekavitar"><i class="bi bi-facebook"></i></a>
        <a href="https://x.com/ekavitaa?t=u_T4a8bxAwXrCFLBYdrYvg&s=08"><i class="bi bi-twitter"></i></a>
        <a href="https://www.instagram.com/ekavitaa_?igsh=bjFleWx2OGwybHZp"><i class="bi bi-instagram"></i></a>
    </div>
</footer><!-- End Footer -->
