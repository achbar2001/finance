                        ...
                        <table class="table" style="vertical-align: middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->email }}</td>
                                    <td>
                                        <form id="updateForm{{ $item->id }}" action="karyawan/jabatan/edit/{{ $item->id }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <select name="jabatan" id="jabatanSelect{{ $item->id }}">
                                                @foreach ($jabatan as $nama_jabatan)
                                                <option value="{{ $nama_jabatan->id_jabatan }}" {{ $nama_jabatan->id_jabatan == $item->id_jabatan ? 'selected' : '' }}>
