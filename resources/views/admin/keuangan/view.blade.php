                    ...
                    <div class="card-body">
                        ...
                        <div style="display: flex; justify-content: space-between;">
                            ...
                            <div>
                                ...
                                {{-- <button type="button" class="btn btn-success" id="arsipkanDataBtn" data-url="https://sib413.eudeka.my.id/keuangan/arsipkan">
                                    Arsipkan Data <i class="fa-regular fa-folder-open"></i>
                                </button> --}}
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/keuangan/{{ $item->id_finance }}/edit" class="btn btn-xs btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                                        <a href="/keuangan/{{ $item->id_finance }}/delete" class="btn btn-xs btn-danger" onclick="return confirm('Are u Sure?');"><i class="fa fa-trash"></i></a>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
