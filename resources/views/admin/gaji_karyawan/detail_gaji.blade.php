                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row" style="font-size:18px; font-weight:bolder">
                            ...
                            <div class="col-sm-9">
                                <input type="text" readonly class="form-control-plaintext" id="namaKaryawan" style="font-size:18px; font-weight:bolder" value=": {{ $detail_gaji[0]->nama_karyawan }}">
                            </div>
                        </div>
                        ...
                        <table class="table" style="vertical-align: middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="/storage/{{ $item->bukti_transfer_gaji }}" target="_blank" class="btn btn-xs btn-info text-white">Lihat Slip Gaji</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
