                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="/profileAdmin">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('company_name') is-invalid @enderror" id="company_name" name="company_name" value="{{ $profileAdmin[0]->company_name }}">
                                    @error('company_name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ $profileAdmin[0]->email }}">
                                    @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="company" name="company" value="{{ $profileAdmin[0]->id_company }}" disabled>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" value="{{ $profileAdmin[0]->alamat }}" disabled>
                            ...
                            <input type="text" class="form-control" name="alamat" id="alamatHidden" value="{{ $profileAdmin[0]->alamat }}" hidden>
